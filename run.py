...
def init(clan_id, accent_color, accent_light):
...
(function() {
  var API = "https://playninjarift.com/api/detail_crew_website.php?crew_id=__CLAN_ID__", RK = "https://playninjarift.com/api/crew_ranking_website.php";
